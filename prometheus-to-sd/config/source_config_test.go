		...
		},
		{
			flags.Uri{
				...
				Val: url.URL{
					...
					Host:     "hostname:1234",
					Path:     defaultMetricsPath,
					RawQuery: "customResourceType=quux&customLabels[some_uid]=&&tenantUIDLabel=some_uid",
				},
			},
			SourceConfig{
				Component:            "testComponent",
		...
		},
		{
			flags.Uri{
				...
				Val: url.URL{
					...
					Host:     "hostname:1234",
					Path:     defaultMetricsPath,
					RawQuery: "customResourceType=quux&customLabels[type]=&&entityTypeLabel=type",
				},
			},
			SourceConfig{
				Component:            "testComponent",
		...
		},
		{
			flags.Uri{
				...
				Val: url.URL{
					...
					Host:     "hostname:1234",
					Path:     defaultMetricsPath,
					RawQuery: "customResourceType=quux&customLabels[name]=&&entityNameLabel=name",
				},
			},
			SourceConfig{
				Component:            "testComponent",
